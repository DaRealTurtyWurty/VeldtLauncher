...
import dev.turtywurty.minecraftlauncher.auth.*;
import dev.turtywurty.minecraftlauncher.auth.pkce.event.*;
import dev.turtywurty.minecraftlauncher.auth.pkce.http.AuthCallbackResult;
import dev.turtywurty.minecraftlauncher.auth.pkce.http.AuthorizationRequestBuilder;
import dev.turtywurty.minecraftlauncher.auth.pkce.http.CallbackServer;
import dev.turtywurty.minecraftlauncher.auth.pkce.http.LocalCallbackServer;
import dev.turtywurty.minecraftlauncher.auth.pkce.microsoft.MicrosoftOAuthClient;
import dev.turtywurty.minecraftlauncher.auth.pkce.microsoft.MicrosoftOAuthService;
import dev.turtywurty.minecraftlauncher.auth.pkce.microsoft.MicrosoftTokenSet;
import dev.turtywurty.minecraftlauncher.auth.pkce.minecraft.*;
import dev.turtywurty.minecraftlauncher.auth.pkce.xbox.XboxAuthService;
import dev.turtywurty.minecraftlauncher.auth.pkce.xbox.XboxAuthenticationService;
import dev.turtywurty.minecraftlauncher.auth.pkce.xbox.XboxToken;
import dev.turtywurty.minecraftlauncher.auth.pkce.xbox.xsts.XstsAuthService;
import dev.turtywurty.minecraftlauncher.auth.pkce.xbox.xsts.XstsAuthorizationService;
